...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Search Pass</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>Search Application Number / Name / Contact number:</h4>
	<div class="form-body">
...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4> 
						...
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th> Application Number</th> <th>Name</th><th>Mobile Number</th> <th>Application Date</th><th>Application Time</th><th>Action</th> </tr> </thead> <tbody>
<?php
