...
<html>
<head>
<title>CEPMS || Accepted Pass</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Accepted Pass</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>Accepted Pass:</h4>
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th> Pass Number</th> <th>Name</th><th>Mobile Number</th> <th>Date</th><th>Time</th><th>Action</th> </tr> </thead> <tbody>
<?php
