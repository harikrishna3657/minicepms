...
<html>
<head>
<title>CEPMS || Search Generated Pass</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Search Generated Pass</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>Search Generated Pass:</h4>
						<div class="form-body">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Search by Pass Id/Number</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
